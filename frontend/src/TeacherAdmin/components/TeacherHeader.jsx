// src/TeacherAdmin/components/TeacherHeader.jsx
    ...
    return (
        <header className="w-full h-[80px] bg-zinc-700 border-b border-zinc-800 px-8 flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
                ...
                {/* Notification */}
                <button className="w-11 h-11 rounded-2xl bg-zinc-900 text-zinc-300 hover:text-blue-400 transition flex items-center justify-center text-lg">
                    <FaBell />
                </button>
