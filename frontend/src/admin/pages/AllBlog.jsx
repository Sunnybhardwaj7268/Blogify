...
import { deleteSingleBlogDetails, getAllBlog } from "../../service/blog";
...
const AllBlog = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            const res = await deleteSingleBlogDetails(id)
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-4">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                {/* View */}
                                                <button className="w-10 h-10 rounded-xl bg-zinc-800 hover:bg-yellow-400 hover:text-black text-white transition flex items-center justify-center" onClick={() => navigate(`/admin/detail-blog/${item._id}`)}>
                                                    <FaEye />
                                                </button>
                                                {/* Edit */}
